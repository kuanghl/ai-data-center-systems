...
![Red-black coloring of the grid and red/black phase update order](assets/red-black-coloring.png)

The left image is a checkerboard coloring in which each color is not a
neighbor of the same color, and the right image is the update order of red cells
and black cells in one iteration. In the red phase, all red cells can be

...
If the Transformer attention flow is not fresh, review the [Transformer appendix](../appendix/transformer/ first. For the full input-to-output generation path, see the [LLM inference appendix](../appendix/llm-inference/.

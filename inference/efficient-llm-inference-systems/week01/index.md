...
```bash
cd /path/to/ai-data-center-systems/inference
...
1. [Efficiently Scaling Transformer Inference](https://arxiv.org/abs/2211.05102) (2022.11) — Analyzes the relationship between batch size, model parallelism, and latency vs. throughput.
2. [Splitwise: Efficient generative LLM inference using phase splitting](https://arxiv.org/abs/2311.18677) (2023.11) — Connects the different resource characteristics of prefill and decode to a split serving design.

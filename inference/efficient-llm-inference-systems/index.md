...
- [FlashAttention from First Principles](../flashattention-from-first-principles/ ([English edition](../flashattention-from-first-principles/README.ko.md)) — explains I/O-aware kernel optimization for exact attention.
